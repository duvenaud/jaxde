...
from jaxde.odeint_zhat import odeint_zhat


def jvp_odeint_zhat((y0, ts, fargs), (tan_y0, tan_ts, tan_fargs), func=None):
    ...
    jvp_t_total = jvp_t_total if tan_y0 is ad_util.zero else tan_y0 + jvp_t_total
    return (np.array([y0, yt]), np.array([tan_y0, jvp_t_total]))


ad.primitive_jvps[odeint_zhat.primitive] = jvp_odeint_zhat
